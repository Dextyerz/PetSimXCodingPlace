...
eggs1:Toggle("Auto Hatch", function(dropegg)
    ...
    local PJWIOEHFIOQHWEIHFIOJWQEIlayerSpoofer___OBFUSCATION___SKYLI000__PLS_NO_HACK____ = misctab:Section("Player Spoofer")
    PJWIOEHFIOQHWEIHFIOJWQEIlayerSpoofer___OBFUSCATION___SKYLI000__PLS_NO_HACK____:DropDown("Select a player", PlayerList, function(LOL)
        game:GetService("ReplicatedStorage").Framework.Modules["2 | Network"]["new stats"]:Fire(Lib.Network.Invoke('Get Stats', game:GetService('Players')[LOL]), game.Players.LocalPlayer)
    end)
